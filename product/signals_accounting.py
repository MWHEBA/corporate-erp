    ...
    try:
        with transaction.atomic():
            ...
            if journal_entry:
                ...
                logger.info(f"Created accounting journal entry for stock movement: {instance.reference_number}")
            else:
...
def delete_accounting_entry_for_stock_movement(sender, instance, **kwargs):
    ...
    try:
        if hasattr(instance, "journal_entry") and instance.journal_entry:
            ...
            logger.info(f"Deleted accounting journal entry for stock movement: {instance.reference_number}")
