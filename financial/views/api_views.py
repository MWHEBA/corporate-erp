...
def data_integrity_check(request):
    ...
    if request.method == "POST":
        try:
            ...
            # Customer balance checks - simplified for ERP system
            results['checks'].append({'name': check_name, 'status': 'passed'})
            results['summary']['passed'] += 1
            ...
            try:
                ...
                # الفواتير التي لم يتم دفعها بالكامل ومضى عليها أكثر من 30 يوم
                from django.utils import timezone
                ...
                if overdue_invoices > 0:
                    results['warnings'].append({
                        ...
                        'message': f"يوجد {overdue_invoices} فاتورة متأخرة لأكثر من 30 يوم",
                        'severity': 'medium'
                    })
                    results['summary']['warnings'] += 1
                else:
