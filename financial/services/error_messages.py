...
class ErrorMessageGenerator:
    ...
    def chart_of_accounts_missing(entity_name: str, entity_type: str) -> str:
        ...
        Example:
            >>> ErrorMessageGenerator.chart_of_accounts_missing("أحمد محمد", "student")
            'لا يوجد حساب محاسبي مرتبط بـ الطالب: أحمد محمد.\\n\\nالإجراء المطلوب: يرجى ربط حساب محاسبي بهذا الطالب من خلال إعدادات الحسابات المحاسبية.'
        """
    ...
    def chart_of_accounts_inactive(account_code: str, account_name: str, entity_name: str = None, entity_type: str = None) -> str:
        ...
        Example:
            >>> ErrorMessageGenerator.chart_of_accounts_inactive("1010", "حساب الطلاب", "أحمد محمد", "student")
            'الحساب المحاسبي (1010 - حساب الطلاب) المرتبط بـ الطالب: أحمد محمد غير مفعّل.\\n\\nالإجراء المطلوب: يرجى تفعيل الحساب المحاسبي من خلال إعدادات دليل الحسابات.'
        """
    ...
    def chart_of_accounts_not_leaf(account_code: str, account_name: str, entity_name: str = None, entity_type: str = None) -> str:
        ...
        Example:
            >>> ErrorMessageGenerator.chart_of_accounts_not_leaf("1000", "الأصول المتداولة", "أحمد محمد", "student")
            'الحساب المحاسبي (1000 - الأصول المتداولة) المرتبط بـ الطالب: أحمد محمد ليس حساباً نهائياً (حساب رئيسي).\\n\\nالإجراء المطلوب: يجب استخدام حساب نهائي (فرعي) وليس حساب رئيسي. يرجى تغيير الحساب المحاسبي إلى حساب فرعي.'
        """
        message = f"الحساب المحاسبي ({account_code} - {account_name})"
    ...
    def accounting_period_missing(transaction_date, entity_name: str = None, entity_type: str = None) -> str:
        ...
        Example:
            >>> from datetime import date
            >>> ErrorMessageGenerator.accounting_period_missing(date(2024, 6, 15), "أحمد محمد", "student")
            'لا توجد فترة محاسبية للتاريخ: 2024-06-15 للمعاملة المتعلقة بـ الطالب: أحمد محمد.\\n\\nالإجراء المطلوب: يرجى إنشاء فترة محاسبية تشمل هذا التاريخ من خلال إعدادات الفترات المحاسبية.'
        """
    ...
    def accounting_period_closed(period_name: str, transaction_date=None, entity_name: str = None, entity_type: str = None) -> str:
        ...
        Example:
            >>> ErrorMessageGenerator.accounting_period_closed("يناير 2024", None, "أحمد محمد", "student")
            'الفترة المحاسبية (يناير 2024) مغلقة ولا يمكن إضافة معاملات جديدة فيها للمعاملة المتعلقة بـ الطالب: أحمد محمد.\\n\\nالإجراء المطلوب: يرجى فتح الفترة المحاسبية أو استخدام تاريخ ضمن فترة مفتوحة.'
        """
