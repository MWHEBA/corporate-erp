                ...
                for leave_type in leave_types:
                    ...
                    if created:
                        ...
                        if balance.total_days != leave_type.max_days_per_year:
                            ...
                            balance.remaining_days = leave_type.max_days_per_year - balance.used_days
                            balance.save()
                            updated_count += 1
            
            if created_count > 0 or updated_count > 0:
                messages.success(request, f'تم تحديث الأرصدة بنجاح: {created_count} رصيد جديد، {updated_count} رصيد محدث')
            else:
