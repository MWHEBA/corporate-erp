...
class ShiftForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'work_hours': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.5', 'min': '0', 'readonly': False}),
        ...
        help_texts = {
            'work_hours': 'سيتم حسابها تلقائياً من أوقات البداية والنهاية',
    ...
    def clean(self):
        ...
        if start_time and end_time:
            # حساب ساعات العمل إذا لم تكن محددة
            if not cleaned_data.get('work_hours'):
                # استخدام نفس منطق الحساب من الـ model
