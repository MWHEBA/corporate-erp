...
class PayrollSignalFeatureFlags:
    ...
    def disable_all(cls) -> None:
        ...
        logger.info("Disabled ALL payroll signal flags (safe rollback)")
...
def register_payroll_signals():
    ...
    """
    logger.info("Registering payroll signal adapters...")
    ...
    logger.info("Payroll signal adapters registered successfully")
...
def initialize_payroll_signals():
    ...
    """
    logger.info("Initializing payroll signal adapters...")
    ...
    logger.info("Payroll signal adapters initialized (all flags disabled for safety)")
    logger.info("Use PayrollSignalFeatureFlags.enable_flag() to enable specific signals")
